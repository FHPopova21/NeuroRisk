...
export const RegisterPage: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Успешна регистрация! Вече можете да влезете.");
      navigate("/login");
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-emerald-50/30 flex items-center justify-center p-4 py-12">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Създаване на профил</h1>
          <p className="text-slate-500 text-center mt-2">
            Присъединете се към клиничната мрежа на NeuroRisk
          </p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          >
            {loading ? "Създаване на профил..." : "Регистрирайте се"}
