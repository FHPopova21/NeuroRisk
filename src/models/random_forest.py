...
class DecisionTree:
    ...
    def fit(self, X, y):
        # Determine number of features to consider (random subspace method)
    ...
    def _best_split(self, X, y, feat_idxs):
        ...
        for feat_idx in feat_idxs:
            ...
            # Optimization: Don't test every single value if there are too many
