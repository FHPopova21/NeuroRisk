...
SECRET_KEY = os.getenv("SECRET_KEY", "neurorisk-edu-clinical-dashboard-secure-key-2026-fhpopova21")
    ...
    def decorated(*args, **kwargs):
        ...
        try:
            ...
            try:
                ...
                # Подаване на текущия потребител като първи позиционен аргумент
